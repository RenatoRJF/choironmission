...
export default function HomeSection() {
  ...
  return <div className="h-screen flex flex-col px-5 md:px-8 lg:px-[4.5rem] bg-home-mic bg-no-repeat bg-95% md:bg-70% xl:bg-60% bg-right-bottom">
    <Header />

    <div className="flex flex-1 flex-col lg:block lg:mt-[6rem] justify-center max-h-[70%] md:max-h-[50%]">
      <h2 className={titleClasses}>
        Transforming lives with songs
      </h2>
